...
export default function AssignmentDetailPage() {
  ...
  // Silent Fetcher (Initial load shows skeleton, sub-actions update silently)
  ...
  if (error || !assignment) return <div className={styles.error}>{error || 'Assignment not found'}</div>;
